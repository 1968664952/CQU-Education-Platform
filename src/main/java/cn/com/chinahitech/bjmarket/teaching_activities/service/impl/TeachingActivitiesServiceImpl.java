package cn.com.chinahitech.bjmarket.teaching_activities.service.impl;
...
import cn.com.chinahitech.bjmarket.teaching_activities.mapper.TeachingActivitiesMapper;
...
public class TeachingActivitiesServiceImpl extends ServiceImpl<TeachingActivitiesMapper, TeachingActivities> implements TeachingActivitiesService {
    ...
    @Override
    public PageBean<TeachingActivities> getlist(Integer pageNum, Integer pageSize, String title, String organizer) {
        //创建pb
        PageBean<TeachingActivities> pb = new PageBean<>();
        //开始分页查询Pagehelper
        PageHelper.startPage(pageNum, pageSize);
        //调用mapper
        List<TeachingActivities> as = teachingActivitiesMapper.showlist(title,organizer);
    ...
    @Override
    public TeachingActivities findById(Integer id){
