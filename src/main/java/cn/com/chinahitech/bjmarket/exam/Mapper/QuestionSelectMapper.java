...
public interface QuestionSelectMapper {
    ...
    @Insert("INSERT INTO question_select(paper_id, question_type, content, option_a, option_b, option_c, option_d, answer, difficulty, explanation) " +
            "VALUES(#{paperId}, #{questionType}, #{content}, #{optionA}, #{optionB}, #{optionC}, #{optionD}, #{answer}, #{difficulty}, #{explanation})")
